    ...
    <form id="form" accept-charset="utf-8" action="<?= $action ?>" data-validate>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <v-select :options="option_gaji" v-model="gaji" class="form-control"></v-select>
        ...
        <div class="form-group">
            <div class="col-md-4 mb-3">
                ...
                <v-select :options="['Hidup','Sudah meniggal', 'Tidak Serumah' ]" v-model="status" class="form-control"></v-select>
