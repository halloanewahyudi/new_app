    ...
    <hr>
     ...
     justify-content:space-between"> <!-- content -->
        ...
        <table>
            ...
            <tr><td>No Pendaftaran</td><td>:</td><td><?= $codereg, $noreg; ?></td>
            ...
            <tr><td>Alamat</td><td>:</td><td><?= $data_santri['alamat']; ?></td></tr>
        ...
        <table>
            <tr><td>Sekolah</td><td>:</td><td><?= $data_sekolah_asal['sekolah_asal'] ?></td></tr>
            <tr><td>NPSN</td><td>:</td><td><?= $data_sekolah_asal['npsn'] ?></td></tr>
            <tr><td>Tahun Lulus</td><td>:</td><td><?= $data_sekolah_asal['tahun_lulus'] ?></td></tr>
            <tr><td>Alamat Sekolah</td><td>:</td><td><?= $data_sekolah_asal['alamat'] ?></td></tr>
            <tr><td>Desa/ Kelurahan</td><td>:</td><td><?= $data_sekolah_asal['desa_kelurahan']; ?></td></tr>
            <tr><td>Kecamatan</td><td>:</td><td><?= $data_sekolah_asal['kecamatan']; ?></td></tr>
            <tr><td>Provinsi</td><td>:</td><td><?= $data_sekolah_asal['provinsi']; ?></td></tr>
            <tr><td>Negara</td><td>:</td><td><?= $data_sekolah_asal['negara']; ?></td></tr>
            <tr><td>Kode Pos</td><td>:</td><td><?= $data_sekolah_asal['kode_pos']; ?></td></tr>
        </table>
        </div> <!-- en sisi kiri -->
             <!-- sisi kanan -->
        <div style="">
