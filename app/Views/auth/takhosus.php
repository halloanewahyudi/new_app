...
<div class="p-5">
    ...
    <form class="user" action="<?= route_to('register') ?>" method="post">
        ...
        <input type="hidden" name="registration_number" value="<?= 'TAKHOSUS' . $belakang_ta_awal, $serial; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 mb-3">
                <!--tanggal lahir -->
                <input type="text" class="datepicker form-control" name="date_of_birth" autocomplete="off">
            </div>
